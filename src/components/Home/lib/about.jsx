...
export function About() {
  return (
    <section id="about-us" className=" relative isolate overflow-hidden flex items-center justify-center p-8  shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)] h-screen">
      ...
      <div className="text-center overflow-visible bg-white rounded-2xl shadow-xl h-90 p-8 md:p-12 relative z-10 transition-transform duration-300 hover:scale-105">
